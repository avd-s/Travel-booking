...
clrscr();
 ...
 gotoxy(20,7);cout<<"Please enter the choice of your mode of transportation......";
...
void travelagency::showtransport()
{
 ...
 gotoxy(15,8);cout<<"Name:"<<strupr(name);
 gotoxy(15,10);cout<<"Address:"<<strupr(add);
 gotoxy(15,12);cout<<"   Destination:"<<destination;
...
void startup()
{
 ...
 for(a=50;a>30;a--)
  ...
  textcolor(WHITE);
  textbackground(RED);
  gotoxy(25,10);cout<<"Welcome to the SPARTANS TRAVEL AGENCY";
  gotoxy(a,12);cout<<" AVD Presents .... ";
  delay(30);
  }
 for(a=42;a<52;a++)
  {
